...
public class ChatViewController {
    ...
    public void addChatter(String emailOfChatter) throws RemoteException{
        ...
        chatVM.startStatusThread(emailOfChatter);
    ...
    public void receiveMessage(Message message){
        if(message.getSenderEmail().equals(userListView.getSelectionModel().selectedItemProperty().getValue())){
            for (Session session : sessions) {
        ...
        }else if(chatters.contains(message.getSenderEmail())) {
